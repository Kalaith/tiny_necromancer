...
| `src/state.rs` and `src/state/economy.rs`: positioned buildings, research, zones, movement destinations, per-source loose piles, carried resources, finite storage, haul plans, and save migration | Add multi-resource chains |
