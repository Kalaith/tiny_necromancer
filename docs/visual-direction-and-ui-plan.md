...
| `src/state.rs`: positioned buildings, research, zones, movement destinations, carried resources, haul plans, and save migration | Add stockpile capacity and multi-resource chains |
