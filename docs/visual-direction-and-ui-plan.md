...
| `src/state.rs` and `src/state/economy.rs`: positioned buildings, research, zones, movement destinations, per-source loose piles, carried resources, haul plans, and save migration | Add stockpile capacity and multi-resource chains |
